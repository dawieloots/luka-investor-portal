  ...
  const phases = [
    {
      ...
      items: [
        ...
        'Begin insurance licensing process',
        'In-house system build',
      ],
    },
    {
      phase: 'Phase 2',
      ...
      status: 'upcoming',
      items: [
        'Core AI-native insurance platform',
        'Underwriting, pricing, & admin modules',
        'Claims & AI agent layers integrated',
        'Licensing targeted for completion',
      ],
    },
    {
      phase: 'Phase 3',
      ...
      status: 'upcoming',
      items: [
        'Staggered go-live with first products',
    ...
    },
    {
      ...
      status: 'upcoming',
      items: [
        'Scale distribution and automation',
        'Prepare for Series A',
        'Accelerate system enhancement',
        'Target break-even (~39 months)',
      ],
    },
  ];
        ...
        <div className="max-w-5xl mx-auto">
              ...
              {phases.map((phase, index) => (
                ...
                >
                  ...
                  <div className={`ml-16 md:ml-0 md:w-[45%] ${index % 2 === 1 ? 'md:mr-auto' : 'md:ml-auto'}`}>
                    <div className={`p-6 rounded-2xl border ${phase.status === 'current'
          ...
          <div className="mt-16 p-8 rounded-2xl bg-card border border-border text-center">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto text-sm">
              As Luka grows, the system learns from every interaction, compounding
              intelligence across underwriting, service, and claims.
            </p>
          </div>
        </div>
      </div>
